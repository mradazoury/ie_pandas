...
def test_input_same_value():
    """This test checks to make sure values in each \
...
def test_sum():
    """ Test and compare the results from the sum function \
...
def test_median():
    """ Test and compare the results from the median \
...
def test_min():
    """ Test and compare the results from the min \
            function against the expected results"""
    result = _df.min()
    expected = [1, 6]
    assert result == expected
...
def test_max():
    """ Test and compare the results from the max \
            function against the expected results"""
    result = _df.max()
    expected = [5, 10]
    assert result == expected
